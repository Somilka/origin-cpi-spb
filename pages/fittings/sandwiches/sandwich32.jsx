    ...
    return (
        <MainLayout>
            <div className="content">
                <div className="title">Сэндвич-панель стандарт 32мм</div>
            ...
            <div className="content">
                ...
                <div className="flex column hr">
                    ...
                    <div className="sizes flex column">
                        ...
                        <div className="size">1500x3000x32</div>
                        <div className="size">2000x3000x32</div>
                        <div className="size">2500x3000x32</div>
                        <div className="size">3000x3000x32</div>
                    </div>
                </div>
            </div>
        </MainLayout>
