    ...
    return (
        <MainLayout>
            <div className="content">
                <div className="title">Ручка оконная Hoppe (compact)</div>
                <div className="full flex jcc">
                    <div className="feature">37mm</div>
                </div>
            </div>
            <div className="content">
                <img className="hl" src="/static/fittings/hoppe_compact/hoppe_compact1.jpg" alt="" />
                <img className="hr" src="/static/fittings/hoppe_compact/hoppe_compact2.jpg" alt="" />
