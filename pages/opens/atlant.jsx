...
export default function Atlant() {
    const [winNav, setWinNav] = useState(5);
    ...
    return (
        <MainLayout>
            ...
            <div className="content atlant">
                ...
                <Link href="/opens/atlant/closures/">
                    <div className="card aic t3 mob-left flex column h100">
                        <h3 className="tac">Затворы</h3>
                        <img className="wa" src="/static/opens/atlant/closures.png" alt="" />
                    </div>
                </Link>
                <Link href="/opens/atlant/shields/">
                    <div className="card aic f3 mob-right flex column h100">
                        <h3 className="tac">Щиты</h3>
                        <img className="wa" src="/static/opens/atlant/shields.jpg" alt="" />
                    </div>
                </Link>
