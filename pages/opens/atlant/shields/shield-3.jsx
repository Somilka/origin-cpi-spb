        ...
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '450px' }} src="/static/opens/atlant/shields/shield-3/shield.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Щит герметический противопожарный АТ.Щ.Г(10).П(EI90).ДГ(S90).С(20),<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/shields/shield-3/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/shields/shield-3/slides/slide2.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
