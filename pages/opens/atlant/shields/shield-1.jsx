...
export default function Shield1() {
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.Щ.Г(10).П(EI30).ДГ(S30).С(20)
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '450px' }} src="/static/opens/atlant/shields/shield-1/shield.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Щит герметический противопожарный АТ.Щ.Г(10).П(EI30).ДГ(S30).С(20),<br />
                        по ТУ 25.11.23-050-52435457-2019, где:<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/shields/shield-1/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/shields/shield-1/slides/slide2.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
