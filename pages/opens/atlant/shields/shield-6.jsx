...
export default function Shield6() {
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.Щ.Г(10).П(EI90).ДГ(S90).С(20) с люком
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '450px' }} src="/static/opens/atlant/shields/shield-6/shield.jpg" alt="" />
                </div>
            ...
            <Slider>
                <img src="/static/opens/atlant/shields/shield-6/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/shields/shield-6/slides/slide2.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
