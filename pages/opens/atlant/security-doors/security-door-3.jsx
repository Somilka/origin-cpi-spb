    ...
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.Д.ВЗ(1,05).ЗЛ(2).ПЛ(Бр4).П(60).С(20)
                </div>
            </div>
            <div className="content">
            ...
            <Slider>
                <img src="/static/opens/atlant/security-doors/security-door3/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-doors/security-door3/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-doors/security-door3/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
