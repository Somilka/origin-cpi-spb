            ...
            <div className="content">
                <Link href="/opens/atlant/fire-fighting-doors/fire-fighting-door-1/">
                    <div className="card jcsb aic f3 mobile-full flex column h100">
                        ...
                        <img className="ha ofcontain" style={{ maxHeight: '242px' }} src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-1.jpg" alt="" />
                    </div>
                </Link>
                <Link href="/opens/atlant/fire-fighting-doors/fire-fighting-door-2/">
                    <div className="card jcsb aic s3 mobile-full flex column h100">
                        ...
                        <img className="ha ofcontain" style={{ maxHeight: '242px' }} src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-2.jpg" alt="" />
                    </div>
                </Link>
                <Link href="/opens/atlant/fire-fighting-doors/fire-fighting-door-3/">
                    <div className="card jcsb aic t3 mobile-full flex column h100">
                        ...
                        <img className="ha ofcontain" style={{ maxHeight: '242px' }} src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-3.jpg" alt="" />
                    </div>
                </Link>
                <Link href="/opens/atlant/fire-fighting-doors/fire-fighting-door-4/">
                    <div className="card jcsb aic s3 mobile-full flex column h100">
                        ...
                        <img className="ha ofcontain" style={{ maxHeight: '242px' }} src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-4.jpg" alt="" />
                    </div>
                </Link>
            </div>
        </MainLayout>
