    ...
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.Д.П(EI30,60,90).С(20) взамен АТ.ПРС.002-004
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="wa" style={{ maxHeight: '450px' }} src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-1/fire-fighting-door.jpg" alt="" />
                </div>
            ...
            <Slider>
                <img src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-1/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-1/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-1/slides/slide3.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-1/slides/slide4.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/fire-fighting-doors/fire-fighting-door-1/slides/slide5.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
