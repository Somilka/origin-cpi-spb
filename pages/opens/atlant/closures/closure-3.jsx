...
export default function Closure3() {
    return (
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '350px' }} src="/static/opens/atlant/closures/closure-3/closure.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Затвор герметический двустворчатый АТ.З2.Г(7).С(60), где:<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/closures/closure-3/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/closures/closure-3/slides/slide2.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
