            ...
            <div className="content">
                <Link href="/opens/atlant/security-others/security-other-1/">
                    <div className="card jcsb aic f3 mobile-full flex column h100">
                        ...
                        <img className="ha ofcontain" style={{ height: '242px' }} src="/static/opens/atlant/security-others/security-other-1.jpg" alt="" />
                    </div>
                </Link>
                <Link href="/opens/atlant/security-others/security-other-2/">
                    <div className="card jcsb aic s3 mobile-full flex column h100">
                        ...
                        <img className="ha ofcontain" style={{ height: '242px' }} src="/static/opens/atlant/security-others/security-other-2.jpg" alt="" />
                    </div>
                </Link>
                <Link href="/opens/atlant/security-others/security-other-3/">
                    <div className="card jcsb aic t3 mobile-full flex column h100">
                        ...
                        <img className="ha ofcontain" style={{ width: '262px' }} src="/static/opens/atlant/security-others/security-other-3.jpg" alt="" />
                    </div>
                </Link>
            </div>
        </MainLayout>
