...
export default function HermeticHatch11() {
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.ЛК.Г(0,4).С(25;30;60)
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '211px' }} src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-11/hermetic-hatch.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Люк-крышка:<br/>
                        АТ.ЛК.Г(0,4).С(25;30;60) по ТУ 25.11.23-508-52435457-2020, где:<br/>
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-11/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-11/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-11/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
