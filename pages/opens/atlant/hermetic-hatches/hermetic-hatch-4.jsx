...
export default function HermeticHatch4() {
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.Л.Г(4).П(EI30).ДГ(S30).С(20) взамен (АТ.ЛПГ.002)
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="wa" style={{ maxHeight: '218px' }} src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-4/hermetic-hatch.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Люк герметический противопожарный дымогазонепроницаемый АТ.Л.Г(4).П(EI30).ДГ(S30).С(20) взамен АТ.ЛПГ.002;<br />
                        АТ.Л.Г(4).П(EI60).ДГ(S60).С(20) взамен АТ.ЛПГ.003;<br />
                        АТ.Л.Г(4).П(EI90).ДГ(S90).С(20) взамен АТ.ЛПГ.004 по ТУ 25.11.23-040-52435457-2018, где:<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-4/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-4/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-4/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
