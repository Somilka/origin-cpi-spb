...
export default function HermeticHatch5() {
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.ЛК.Г(4).П(EI30).ДГ(S30).С(20) взамен АТ.ЛК.ЗГ.002
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="wa" style={{ maxHeight: '218px' }} src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-5/hermetic-hatch.jpg" alt="" />
                </div>
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-5/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-5/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-5/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
