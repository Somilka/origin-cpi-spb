...
export default function HermeticHatch10() {
    return (
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '211px' }} src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-10/hermetic-hatch.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Люк-крышка:<br/>
                        АТ.Л.С(20) по ТУ 25.11.23-508-52435457-2020, где:<br/>
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-10/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-10/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-10/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
