...
export default function HermeticHatch8() {
    return (
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="wa" style={{ maxHeight: '218px' }} src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-8/hermetic-hatch.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Люк круглый герметический:<br />
                        АТ.ЛК.Р.Г(0,04).С(20) по ТУ 25.11.23-510-52435457-2020, где:<br />
                        0,04 – герметичность, л/ч;<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-8/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-8/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-8/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
