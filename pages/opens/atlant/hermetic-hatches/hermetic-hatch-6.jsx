...
export default function HermeticHatch6() {
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.ЛК.Г(4).П(EI60).ДГ(S60).С(20) взамен АТ.ЛК.ЗГ.003
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="wa" style={{ maxHeight: '218px' }} src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-6/hermetic-hatch.jpg" alt="" />
                </div>
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-6/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-6/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-6/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
