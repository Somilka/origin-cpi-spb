...
export default function HermeticHatch2() {
    return (
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="wa" style={{ maxHeight: '218px' }} src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-2/hermetic-hatch.jpg" alt="" />
                </div>
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-2/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-2/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-2/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
