...
export default function HermeticHatch1() {
    return (
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '211px' }} src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-1/hermetic-hatch.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Люк герметический АТ.Л.Г(4).С(20) взамен АТ.ЛГ.001 по ТУ 7399-425-52435457-2014 где:<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-1/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-1/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-hatches/hermetic-hatch-1/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
