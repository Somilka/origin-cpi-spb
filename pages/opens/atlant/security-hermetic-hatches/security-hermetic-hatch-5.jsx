...
export default function SecurityHermeticHatch5() {
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.Л.ВЗ(5).Г(4).П(EI90).ДГ(S90).С(20) взамен АТ.Л.ВЗГ.004
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="wa" style={{ maxHeight: '218px' }} src="/static/opens/atlant/security-hermetic-hatches/security-hermetic-hatch-5/security-hermetic-hatch.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Люк защитно-герметический:<br/>
                        АТ.Л.ВЗ(5).Г(4).П(EI90).ДГ(S90).С(20) взамен АТ.Л.ВЗГ.004 по ТУ 25.11.23-005-52435457-2019, где:<br/>
                        5 – эквивалентная статическая нагрузка, МПа;<br/>
                        4 – герметичность, л/ч;<br/>
                        EI90 – предел огнестойкости, мин;<br/>
                        S90 – дымогазонепроницаемость, мин;<br/>
            ...
            <Slider>
                <img src="/static/opens/atlant/security-hermetic-hatches/security-hermetic-hatch-5/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-hermetic-hatches/security-hermetic-hatch-5/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-hermetic-hatches/security-hermetic-hatch-5/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
