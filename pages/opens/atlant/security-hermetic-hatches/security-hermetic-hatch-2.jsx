...
export default function SecurityHermeticHatch2() {
    return (
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '211px' }} src="/static/opens/atlant/security-hermetic-hatches/security-hermetic-hatch-2/security-hermetic-hatch.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Люк взрывозащитный герметический АТ.Л.ВЗ(5).Г(4).С(20) , где:<br/>
            ...
            <Slider>
                <img src="/static/opens/atlant/security-hermetic-hatches/security-hermetic-hatch-2/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-hermetic-hatches/security-hermetic-hatch-2/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-hermetic-hatches/security-hermetic-hatch-2/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
