    ...
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.Л.П(EI30,60,90).С(20) взамен АТ.Л.ПРС.002-004
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="wa" style={{ height: '450px' }} src="/static/opens/atlant/fire-fighting-hatches/fire-fighting-hatches-1/fire-fighting-hatch-1.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Люк противопожарный:<br />
                        АТ.Л.П(EI30).С(20) взамен АТ.Л.ПРС.002<br />
                        АТ.Л.П(EI60).С(20) взамен АТ.Л.ПРС.003<br />
                        АТ.Л.П(EI90).С(20) взамен АТ.Л.ПРС.004 по ТУ 7399-002-52435457-2015,где:<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/fire-fighting-hatches/fire-fighting-hatches-1/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/fire-fighting-hatches/fire-fighting-hatches-1/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/fire-fighting-hatches/fire-fighting-hatches-1/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
