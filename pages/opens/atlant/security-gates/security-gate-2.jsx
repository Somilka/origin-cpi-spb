        ...
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '400px' }} src="/static/opens/atlant/security-gates/security-gate-2/security-gate.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Ворота защитные АТ.ВР.ЗЛ(3).ПЛ(БР5).С(20) взамен АТ.БР.ВР.002, где:<br />
                        3 – класс взломостойкости;<br />
                        Бр5 – класс пулестойкости;<br />
                        20 – сейсмоударостойкость, g,<br />
                        предназначена для защиты транспортных проемов от несанкционированного проникновения.
                    </p>
                    <div>
                        <p>
                            Ворота изготавливаются как с калиткой, так и без калитки.<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/security-gates/security-gate-2/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-gates/security-gate-2/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-gates/security-gate-2/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
