    ...
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.Д.Г(10).П(EI150).ДГ(S150).С(20).1;2;3;4;5
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '400px' }} src="/static/opens/atlant/hermetic-doors/hermetic-door-5/hermetic-door.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Дверь герметическая противопожарная:<br/>
                        АТ.Д.Г(10).П(EI150).ДГ(S150).С(20) по ТУ 25.11.23-032-52435457-2018, где:<br/>
                        10 – герметичность, л/ч;<br/>
                        EI150  – предел огнестойкости, мин;<br/>
                        S150– дымогазонепроницаемость, мин;<br/>
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-5/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-5/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-5/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
