    ...
    return (
        <MainLayout>
            <div className="content">
                <div className="title">
                    АТ.Д.Г(10).П(EI90).ДГ(S90).С(20).1;2;3;4;5
                </div>
            </div>
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '400px' }} src="/static/opens/atlant/hermetic-doors/hermetic-door-7/hermetic-door.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Дверь герметическая противопожарная:<br/>
                        АТ.Д.Г(10).П(EI90).ДГ(S900).С(20) по ТУ 25.11.23-032-52435457-2018, где:<br/>
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-7/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-7/slides/slide2.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
