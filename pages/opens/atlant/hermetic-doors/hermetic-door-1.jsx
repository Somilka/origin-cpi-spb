        ...
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '400px' }} src="/static/opens/atlant/hermetic-doors/hermetic-door-1/hermetic-door.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Дверь герметическая: АТ.Д.Г(10).С(20).1;2;3 по ТУ 7399-425-52435457-2014;<br />
                        где:<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-1/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-1/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-1/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
