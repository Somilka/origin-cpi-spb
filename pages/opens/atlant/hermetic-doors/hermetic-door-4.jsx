        ...
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '400px' }} src="/static/opens/atlant/hermetic-doors/hermetic-door-4/hermetic-door.jpg" alt="" />
                </div>
            ...
            <Slider>
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-4/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-4/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/hermetic-doors/hermetic-door-4/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
