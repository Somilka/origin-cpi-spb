        ...
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '400px' }} src="/static/opens/atlant/security-hermetic-doors/security-hermetic-door-2/security-hermetic-door.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Дверь защитно-герметическая АТ.Д.ВЗ(10).Г(10).С(20), где:<br />
            ...
            <Slider>
                <img src="/static/opens/atlant/security-hermetic-doors/security-hermetic-door-2/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-hermetic-doors/security-hermetic-door-2/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-hermetic-doors/security-hermetic-door-2/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
