        ...
        <MainLayout>
            ...
            <div className="content">
                ...
                <div className="flex hl aic jcc h100">
                    <img className="ha" style={{ maxWidth: '400px' }} src="/static/opens/atlant/security-hermetic-doors/security-hermetic-door-1/security-hermetic-door.jpg" alt="" />
                </div>
                <div className="hr flex column bigger-gap">
                    <p>
                        Дверь защитно-герметическая АТ.Д.ВЗ(24).Г(10).С(250), где:<br />
                        24 – эквивалентная статическая нагрузка, МПа;<br />
                        10 – герметичность, л/ч;<br />
                        250 – сейсмоударостойкость, g,<br />
                        предназначена для защиты и герметизации входных проемов в специальные фортификационные сооружения.<br />
                        Обеспечивает защиту входных проемов в специальные сооружения от поражающих факторов ядерного взрыва.
                    </p>
                    <div>
                        <p>
            ...
            <Slider>
                <img src="/static/opens/atlant/security-hermetic-doors/security-hermetic-door-1/slides/slide1.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-hermetic-doors/security-hermetic-door-1/slides/slide2.jpg" alt="" className="slide" />
                <img src="/static/opens/atlant/security-hermetic-doors/security-hermetic-door-1/slides/slide3.jpg" alt="" className="slide" />
            </Slider>
        </MainLayout >
    );
};
