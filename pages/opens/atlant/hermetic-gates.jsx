            ...
            <div className="content">
                <Link href="/opens/atlant/hermetic-gates/hermetic-gate-1/">
                    <div className="card jcsb aic hl flex column h100">
                        ...
                        <img className="ha ofcontain" style={{ maxWidth: '262px' }} src="/static/opens/atlant/hermetic-gates/hermetic-gates1.jpg" alt="" />
                    </div>
                </Link>
                <Link href="/opens/atlant/hermetic-gates/hermetic-gate-2/">
                    <div className="card jcs aic hr flex column h100">
                        ...
                        <img className="ha ofcontain" style={{ maxWidth: '262px' }} src="/static/opens/atlant/hermetic-gates/hermetic-gates2.jpg" alt="" />
                    </div>
                </Link>
            </div>
        </MainLayout>
